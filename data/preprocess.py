...
data_path = '/data2/liuguodong/DA/AliExpress/'
...
df_train_item = pd.read_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/{}_item_train.csv'.format(dataset_name, dataset_name.lower()), header=None, names=['item_{}'.format(i) for i in range(1, 50)])
df_test_item = pd.read_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/{}_item_test.csv'.format(dataset_name, dataset_name.lower()), header=None, names=['item_{}'.format(i) for i in range(1, 50)])
df_train_user = pd.read_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/{}_user_train.csv'.format(dataset_name, dataset_name.lower()), header=None, names=['user_{}'.format(i) for i in range(1, 34)])
df_test_user = pd.read_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/{}_user_test.csv'.format(dataset_name, dataset_name.lower()), header=None, names=['user_{}'.format(i) for i in range(1, 34)])
...
df_final_train.to_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/train.csv'.format(dataset_name), index=0)
df_final_test.to_csv('/data2/liuguodong/DA/AliExpress/AliExpress_{}/test.csv'.format(dataset_name), index=0)